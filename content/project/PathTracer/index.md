...
| :-------------------------------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
|         cornell_box_full_lighting.ini         | ![](/src/graphics/example-scenes/ground_truth/final/cornell_box_full_lighting.png) | ![Place cornell_box_full_lighting.png in student_outputs/final folder](/src/graphics/student_outputs/final/cornell_box_full_lighting.png) |
|     cornell_box_direct_lighting_only.ini      | ![](/src/graphics/example-scenes/ground_truth/final/cornell_box_direct_lighting_only.png) | ![Place cornell_box_direct_lighting_only.png in student_outputs/final folder](/src/graphics/student_outputs/final/cornell_box_direct_lighting_only.png) |
| cornell_box_full_lighting_low_probability.ini | ![](/src/graphics/example-scenes/ground_truth/final/cornell_box_full_lighting_low_probability.png) | ![Place cornell_box_full_lighting_low_probability.png in student_outputs/final folder](/src/graphics/student_outputs/final/cornell_box_full_lighting_low_probability.png) |
|                  mirror.ini                   |      ![](/src/graphics/example-scenes/ground_truth/final/mirror.png)       | ![Place mirror.png in student_outputs/final folder](/src/graphics/student_outputs/final/mirror.png) |
|                  glossy.ini                   |      ![](/src/graphics/example-scenes/ground_truth/final/glossy.png)       | ![Place glossy.png in student_outputs/final folder](/src/graphics/student_outputs/final/glossy.png) |
|                refraction.ini                 |    ![](/src/graphics/example-scenes/ground_truth/final/refraction.png)     | ![Place refraction.png in student_outputs/final folder](/src/graphics/student_outputs/final/refraction.png) |
...
Example: `template_inis/extra/attenuate_refraction.ini`
 ...
 <img src="/src/graphics/student_outputs/final/refraction.png" alt="softshadow" style="zoom:45%;" /> <img src="/src/graphics/student_outputs/extra/attenuate_refraction.png" alt="softshadow" style="zoom:45%;" />
...
Example: `template_inis/extra/dof.ini`
 ...
 <img src="/src/graphics/student_outputs/final/glossy.png" alt="softshadow" style="zoom:40%;" /> <img src="/src/graphics/student_outputs/extra/glossy_dof_3.png" alt="softshadow" style="zoom:40%;" /> 

<img src="/src/graphics/student_outputs/extra/glossy_dof_4.png" alt="softshadow" style="zoom:40%;" /> <img src="/src/graphics/student_outputs/extra/glossy_dof_5.png" alt="softshadow" style="zoom:40%;" />
...
* **Ideal diffuse**
  ...
  <img src="/src/graphics/student_outputs/final/cornell_box_full_lighting.png" alt="softshadow" style="zoom:55%;" /> <img src="/src/graphics/student_outputs/extra/IS_cornell.png" alt="softshadow" style="zoom:55%;" />
...
* **Glossy specular**
  ...
  <img src="/src/graphics/student_outputs/final/glossy.png" alt="softshadow" style="zoom:55%;" /> <img src="/src/graphics/student_outputs/extra/IS_glossy.png" alt="softshadow" style="zoom:55%;" />
...
* **Ideal specular (mirror)**
  ...
  <img src="/src/graphics/student_outputs/final/mirror.png" alt="softshadow" style="zoom:55%;" /> <img src="/src/graphics/student_outputs/extra/IS_mirror.png" alt="softshadow" style="zoom:55%;" />
...
* **Dielectric refraction (refraction + Fresnel reflection)**
  ...
  <img src="/src/graphics/student_outputs/final/refraction.png" alt="softshadow" style="zoom:55%;" /> <img src="/src/graphics/student_outputs/extra/IS_refraction.png" alt="softshadow" style="zoom:55%;" />
...
Example: `template_inis/extra/denoise_on.ini` and `template_inis/extra/denoise_off.ini`
 ...
 <img src="/src/graphics/student_outputs/extra/cornell_box_denoise_off.png" alt="softshadow" style="zoom:45%;" /> <img src="/src/graphics/student_outputs/extra/cornell_box_denoise_on.png" alt="softshadow" style="zoom:45%;" /> 
